    ...
    <footer className="bg-black text-white py-8 ">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="mb-8 md:mb-0">
            <h2 className="text-2xl font-bold mb-4">
              <span className="text-orange-500">Digi</span>ency
            </h2>
          ...
          <div>
            <h3 className="text-xl font-bold text-orange-500 mb-4">Call Us</h3>
            <p className="text-white mb-2 text-sm md:text-base">(252) 555-0126</p>
            <p className="text-white text-sm md:text-base">info@youremai.com</p>
          </div>
          
          <div>
            <h3 className="text-xl font-bold text-orange-500 mb-4">Follow Us</h3>
            <div className="flex space-x-3 ml-[80px] md:mt-6 ">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white mb-4 md:mb-0 text-sm md:text-base text-center md:text-left">
            <span className="mr-2">©</span>
            Copyright 2021. All Right Reserved By Oijomedia
          </p>
          <div className="flex space-x-4 mb-4 md:mb-0">
            <a href="#" className="text-white hover:text-orange-500 text-sm md:text-base">Privacy Policy</a>
            <a href="#" className="text-white hover:text-orange-500 text-sm md:text-base">Therms of Us</a>
          </div>
